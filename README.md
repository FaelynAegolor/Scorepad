...
- **Saved setups** — got a regular group? Save your players (and the game they usually play) as a named setup, and next time it's one tap instead of typing everyone's name in again. Lives in its own personal library that survives even a full Reset everything, the same way your theme choice already does.
